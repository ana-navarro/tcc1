            ...
            <div className='h-screen w-screen pb-20'>
                ...
                <div className='main'>
                    <Container className='py-6'>
                        <Card>
                            <Card.Header>
                                <p className="text-2xl font-bold text-center py-2"> <strong>Lista de Usinas</strong></p>
                            </Card.Header>
                            <Card.Body>
                                    <div className='text-center'>
                                        <a className="btn btn-success text-white font-bold m-2" href='/company/add'>Adicionar nova Empresa</a>
                                    </div>
                                    <table className="table">
                                        <thead>
                                            <tr>
                                            <th scope="flex flex-col items-center justify-center">CNPJ</th>
                                            <th scope="flex flex-col items-center justify-center">Nome</th>
                                            <th scope="flex flex-col items-center justify-center">Email</th>
                                            <th scope="flex flex-col items-center justify-center">Cidade</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><Link to={`/company/${company._id}`}>{company.email}</Link></td>
                                            <td><Link to={`/company/${company._id}`}>{company.city}</Link></td>
                                            <td className='p-2'>
